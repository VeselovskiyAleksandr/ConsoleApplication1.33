...
public:
	...
	Dog(const string _name, const string toyName, int _age) : name(_name), loveToy(toyName) {
		...
		lovelytoy= loveToy.getToy();
		cout << "\nDog: " << getname() << " " << getage() << " " << loveToy.getToy()->getName();
		cout << "\n counter " << " after string name constructer = " << loveToy.getCounter();//<< toy.getName()
	};
	...
	Dog(const Dog& oth) :loveToy(oth.loveToy) {
		...
		age = oth.age;
		cout << "\nDog: " << getname() << " " << getage();// << " " << toy.getName();
		cout << "\n counter " << " after copy constructer = " << loveToy.getCounter(); //<< toy.getName()
	}
	~Dog() {
		cout << "\n delete dog " << getname();
	}
